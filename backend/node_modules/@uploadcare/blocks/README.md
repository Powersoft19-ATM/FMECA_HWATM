...
This package has been renamed to [@uploadcare/file-uploader](https://www.npmjs.com/package/@uploadcare/file-uploader). Please migrate to the new package to continue receiving updates and support.
You can find the migration guide [here](https://uploadcare.com/docs/file-uploader/migration-to-1.x/).
